#!/usr/bin/env python3
"""Grab a cube in front of the robot without moving the base.

    observe -> FK -> detect -> transform -> IK -> reach -> grasp -> verify

Every intermediate value is printed so the coordinate accuracy can be judged
directly rather than inferred from whether the grab happened to work.
"""
